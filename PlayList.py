# Programa para reproducir las listas de canciones. con el algoritmos de estructura de datos
# De listas en Python
...
#lista_reproduccion.sort(reverse=True) Para ordenar de manera descendente
