# Desafio para la implementacion de un sistema de inventario complejos con algoritmos y estructuras de datos en diccionarios.
# Por lo que se combinaran las listas con diccionario.
...
#Se implementa la funcion range() para facilitar la iteracion en el la lista de productos para agregar
#Con esto se establecera cuantos productos se van a cargar.
#Donde se ingresaran los productos medianta sus valores mas primitivos y luego se armara un diccionario. Este Ultimo se agregara con append()
...
# Con estas sentencias se hara un recorrido sin range() mediante id que sera ingresado por el usuario
# Este se devolvera los producto encontrado
# En caso de encontrarlo este se devolvera un detalle con el mismo en caso contrario un mensaje.
...
# Muestra todo el inventario en detalle
